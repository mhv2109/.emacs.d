...
;; RSS Reader:
;;   - https://www.gnu.org/software/emacs/manual/html_mono/newsticker.html#Top
;;   - https://codelearn.me/2025/04/09/emacs-newsticker.html
(use-package newsticker
  :ensure nil
  :bind
  (("C-c r" . newsticker-show-news))
  :config
  (setq newsticker-url-list '(;; Emacs
                              ("Emacs Wiki" "https://www.emacswiki.org/emacs?action=rss")
                              ("Planet Emacslife" "https://planet.emacslife.com/atom.xml")
                              ("Mastering Emacs" "https://www.masteringemacs.org/feed")
                              ;; AWS
                              ("AWS Recent Announcements" "https://aws.amazon.com/about-aws/whats-new/recent/feed/")
                              ("AWS News" "https://aws.amazon.com/blogs/aws/feed/")
                              ;; Cloudflare
                              ("Cloudflare" "https://blog.cloudflare.com/rss")
                              ;; K8s
                              ("K8s CVE Feed" "https://kubernetes.io/docs/reference/issues-security/official-cve-feed/feed.xml")
                              ...
                              ("Applied Go" "https://appliedgo.net/index.xml")
                              ...
                              ("iRi" "https://jerf.org/iri/rss.xml")
                              ("Russ Cox" "http://research.swtch.com/feed.atom")
                              ("Ardan Labs" "https://www.ardanlabs.com/blog/index.xml")
                              ("Rob Pike" "https://commandcenter.blogspot.com/feeds/posts/default?alt=rss")
                              ;; Python
                              ("Python PEPs" "https://peps.python.org/peps.rss")
                              ("Python Insider" "https://feeds.feedburner.com/PythonInsider")
                              ("Python Releases" "https://www.python.org/downloads/feed.rss")
                              ("Python->Speed" "https://pythonspeed.com/atom.xml")
                              ("Seth Larson" "https://sethmlarson.dev/feed")
                              ;; Java
                              ("Baeldung" "https://feeds.feedblitz.com/baeldung&x=1")
                              ...
                              ("Giles Thomas" "https://www.gilesthomas.com/feed/rss.xml")
                              ("Sean Goedecke" "https://www.seangoedecke.com/rss.xml")
                              ;; Lisp
                              ("Abstract Heresies" "https://funcall.blogspot.com/feeds/posts/default")
                              ;; Misc. Tech
                              ...
                              ("Jane Street Blog" "https://blog.janestreet.com/feed.xml")
                              ("Mozilla Hacks" "https://hacks.mozilla.org/feed/")
                              ("Netflix Tech Blog" "https://netflixtechblog.com/feed")
                              ("Shopify Engineering" "https://shopify.engineering/blog.atom")
                              ("Slack Engineering" "https://slack.engineering/rss")
                              ("Spotify Engineering" "https://engineering.atspotify.com/feed")
                              ("StackOverflow Blog" "https://stackoverflow.blog/feed")
                              ("InfoQ" "https://feed.infoq.com/")
                              ("Passo Uno" "https://passo.uno/posts/index.xml")
                              ("Werner Vogels" "https://www.allthingsdistributed.com/atom.xml")
                              ("rachelbythebay" "https://rachelbythebay.com/w/atom.xml")
                              ("ACM" "https://queue.acm.org/rss/feeds/queuecontent.xml")
                              ("Christian Posta" "https://blog.christianposta.com/feed.xml")
                              ;; News
                              ("ABC News" "https://abcnews.go.com/abcnews/topstories")
                              ("BBC News" "https://feeds.bbci.co.uk/news/world/rss.xml")
                              ("FOX News" "https://moxie.foxnews.com/google-publisher/latest.xml")
                              ("WCNC News" "https://www.wcnc.com/feeds/syndication/rss/news"))))
