...
## Python
Python configurations based on [this configuration](https://realpython.com/emacs-the-best-python-editor/).
...
## JS
JS/Nodejs configurations based on [this article](https://truongtx.me/2014/02/23/set-up-javascript-development-environment-in-emacs).
For js-mode to wirk correctly, the following packages are necessary:
```
$ npm install -g jshint js-beautify
```

For web-beautify and js-beautify to work as desired, set up a `.jsbeautifyrc`.  My default settings are included in the repo.  See [web-beautify](https://github.com/yasuyk/web-beautify) and [js-beautify](https://github.com/beautify-web/js-beautify) for details.
